# @zibuthe7j11/molestias-sint-facilis

> forked from [@zibuthe7j11/molestias-sint-facilisode](https://www.npmjs.com/package/@zibuthe7j11/molestias-sint-facilisode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@zibuthe7j11/molestias-sint-facilisode/issues/300).

[![npm version](https://img.shields.io/npm/v/@zibuthe7j11/molestias-sint-facilis.svg)](https://www.npmjs.com/package/@zibuthe7j11/molestias-sint-facilis)
[![Downloads](https://img.shields.io/npm/dm/@zibuthe7j11/molestias-sint-facilis.svg)](https://www.npmjs.com/package/@zibuthe7j11/molestias-sint-facilis)
[![Build Status](https://github.com/zibuthe7j11/molestias-sint-facilis/workflows/CI/badge.svg)](https://github.com/zibuthe7j11/molestias-sint-facilis/actions)
...
```sh
npm install --save-dev eslint @zibuthe7j11/molestias-sint-facilis
```
...
```js
const nodePlugin = require("@zibuthe7j11/molestias-sint-facilis")
...
💼 [Configurations](https://github.com/zibuthe7j11/molestias-sint-facilis#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/zibuthe7j11/molestias-sint-facilis#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/zibuthe7j11/molestias-sint-facilis#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/zibuthe7j11/molestias-sint-facilis#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/zibuthe7j11/molestias-sint-facilis#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/zibuthe7j11/molestias-sint-facilis#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/zibuthe7j11/molestias-sint-facilis#-configs).\
...
`@zibuthe7j11/molestias-sint-facilis` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/zibuthe7j11/molestias-sint-facilis/releases)
